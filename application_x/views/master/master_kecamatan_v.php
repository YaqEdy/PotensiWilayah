        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Data Kecamatan</span>
                </div>
                <div class="tools">
...
<!--                                                         <th>
                      ...
                      action="<?php echo base_url('master/master_kecamatan/home'); ?>" id="id_formKec">
                                ...
                                <div class="form-body">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="id_namaKec" required="required" class="form-control input-sm"
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            var table = $('#idTabelKec');

            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/master/master_kecamatan/getKecAll"); ?>",
                "columns": [
                    {"data": "idKec"},
                    {"data": "namaKec"}
                    /*,
            ...
            table.on('click', 'tbody tr', function () {
                var idKec = $(this).find("td").eq(0).html();
    ...
    $("#id_kecId").focusout(function () {
        var idKec = $(this).val();
        getDescKec(idKec);
    });
    function getDescKec(idKec) {
        ajaxModal();
        if (idKec != '') {
            $.post("<?php echo site_url('/master/master_kecamatan/getDescKec'); ?>",
                    {
                        'idKec': idKec
                    }, function (data) {
                if (data.baris == 1) {
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_kecamatan/simpan",
            data: dataString,
    ...
    function ajaxUbah() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_kecamatan/ubah",
            data: dataString,
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
    ...
    function ajaxHapus() {
        ajaxModal();
        var idKec = $('#id_kecId').val();
        idKec = idKec.trim();
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_kecamatan/hapus",
            data: {idKec: idKec},
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
    ...
    $('#id_formKec').submit(function (event) {
        dataString = $("#id_formKec").serialize();
