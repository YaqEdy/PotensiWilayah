...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>SIM Potensi Wilayah | Login </title>
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    <div class="row">
                        <div class="col-xs-2">
                            <img class="login-logo login-6" src="<?php echo base_url('metronic/img/logo2.png'); ?>" />
                        </div>
                    ...
                    <div class="login-content">
                        <h1>Sistem Informasi Potensi Wilayah</h1>
                        <h2> Login</h2>
...
<![endif]-->
        ...
        <script type="text/javascript">
            ...
            var Login = function () {
                ...
                return{init: function () {
                        r(), $(".login-bg").backstretch(["<?php echo base_url('metronic/pages/img/login/bupati.jpeg') ?>", "<?php echo base_url('metronic/pages/img/login/wakil_bupati.jpeg') ?>"], {fade: 1e3, duration: 8e3}), $(".forget-form").hide()
                    }}
            }();
            jQuery(document).ready(function () {
                Login.init();
