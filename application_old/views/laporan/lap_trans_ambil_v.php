                    ...
                    <div class="col-md-9">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label>Bayar</label>
                                    <select id="id_status_bayar" name="status_bayar" class="form-control">
        ...
        var initTable1 = function () {
            ...
            var table = $('#idTabelPO'),
                    t = table.dataTable({
                        "ajax": {
                            'type': 'POST',
                            'url': '<?php echo base_url("/laporan/lap_trans_ambil/getCucianAmbil"); ?>',
                            'data': function (d) {
                                d.tglAwalDaftar = $('#id_tglAwalDataDaftar').val();
                                d.tglAkhirDaftar = $('#id_tglAkhirDataDaftar').val();
                                d.statusBayar = $('#id_status_bayar').val();
                            }
                        },
                        "columns": [
                            {"data": "noSeq"},
