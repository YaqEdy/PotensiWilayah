        ...
        <div class="portlet portlet-sortable light bordered">
            ...
            <div class="portlet-body">
                ...
                <form role="form" method="post"
                      action="<?php echo base_url('transaksi/trans_masuk_unpo/home'); ?>" id="id_formAdvance">
    ...
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Data produk yang masuk</h4>
            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input id="id_hargaSatuan"  class="form-control input-sm nomor kosongNomorDetail cls_hitungTotalHarga"
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 kanan">
                                                            <span id="id_hargaTotal" class="kosongTextDetail"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
                        ...
                        function getDescProduk(idProduk) {
                            ajaxModal();
                            if (idProduk != '') {
                                $.post("<?php echo site_url('transaksi/trans_masuk_unpo/getDescProduk'); ?>",
                                        {
                                            'idProduk': idProduk
                                        }, function (data) {
                                    if (data.baris == 1) {
                        ...
                        function getDescStorage(idStorage) {
                            ajaxModal();
                            if (idStorage != '') {
                                $.post("<?php echo site_url('transaksi/trans_masuk_unpo/getDescStorage'); ?>",
                                        {
                                            'idStorage': idStorage
                                        }, function (data) {
                                    if (data.baris == 1) {
                        ...
                        function ajaxSubmitAdvance() {
                            ...
                            $.ajax({
                                type: "POST",
                                dataType: "json",
                                url: "<?php echo base_url(); ?>transaksi/trans_masuk_unpo/simpan",
                                data: dataString,
                        ...
                        function cetak() {
                            ...
                            if (masterId == '') {
                                ...
                                window.open("<?php echo base_url('transaksi/trans_masuk_unpo/cetakSTB/'); ?>/"+ masterId, '_blank');//+ idAdvance + masterId
                            }
                        }
