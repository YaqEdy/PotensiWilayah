        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <form role="form" method="post" class="cls_from_rumah"
                      action="<?php echo base_url('trans_biaya/home'); ?>" id="id_formIntegrasi">
                    <div class="row">
                        ...
                        <div class="form-body">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="input-group">
                                                <input id="id_namaJurnal" required="required" readonly="readonly" class="form-control  input-sm"
                                ...
                                <div class="form-group">
                                    <label>Rek GL :</label>
                                    <span id="id_namaGL"></span>
                                </div>
                                <div class="form-group">
                                        <label>Jumlah transaksi</label>
                                        <input type="text" class="form-control input-sm nomor" name="jml_trans">
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTableJurnal = function () {
            ...
            var table = $('#idTabelJurnal').dataTable({
                "ajax": "<?php echo base_url("/transaksi/trans_biaya/getAllJurnal"); ?>",
                "columns": [
            ...
            table.on('click', 'tbody tr', function () {
                ...
                $('#id_namaGL').text(namaPerk);
                var keterangan = $(this).find("td").eq(4).html();
                $('#id_keterangan').val(namaJurnal);
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>transaksi/trans_biaya/simpan",
            data: dataString,
    ...
    function ajaxUbah() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>transaksi/trans_biaya/ubah",
            data: dataString,
            success: function (data) {
                $('#id_ReloadJurnal').trigger('click');
                $('#id_btnBatal').trigger('click');
    ...
    function ajaxHapus() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>transaksi/trans_biaya/hapus",
