...
<style type="text/css">
    ...
    table#idTabelPO th:nth-child(14), td:nth-child(14), th:nth-child(16), td:nth-child(16), th:nth-child(18), td:nth-child(18){
        display: none;
    }
</style>
<!-- END PAGE BREADCRUMB -->
                        ...
                        var TableManaged = function () {
                            ...
                            var initTable1 = function () {
                                ...
                                table.dataTable({
                                    "ajax": {
                                        'type': 'POST',
                                        'url': '<?php echo base_url("/transaksi/trans_app_kirim/getRencanaOutAll"); ?>',
                                        'data': function (d) {
                                    ...
                                    "columns": [
                                        ...
                                        {"data": "no_cukai"},
                                        {"data": "keterangan_so"},
                                        {"data": "label_distribusi"},
                                        {"data": "flag_distribusi"},
                                        {"data": "label_pack"},
                                        {"data": "flag_pack"},
                                        {"data": "label_keluar"},
                                        {"data": "flag_keluar"}
                                ...
                                table.on('click', 'tbody tr', function () {
                                    ...
                                    var status_distribusi = $(this).find("td").eq(13).html();
                                    status_distribusi.trim();
                                    var status_pack = $(this).find("td").eq(15).html();
                                    status_pack.trim();
                                    var status_kirim = $(this).find("td").eq(17).html();
                                    status_kirim.trim();
                                    if(status_distribusi == '1' && status_pack == '1'){
                                        window.open(baseurl + "transaksi/trans_app_kirim/selectedSO/" + noSO + "/" + status_kirim, "_self");
                                    }else if(status_distribusi == '0' && status_pack == '1'){
                                        bootbox.alert("Data Pengiriman belum terdistribusi!");
                                    }else if(status_distribusi == '1' && status_pack == '0'){
                                        bootbox.alert("Data Pengiriman belum packing!");
                                    }else{
                                        bootbox.alert("Data Pengiriman belum terdistribusi dan belum packing!")
                                    }
                                });
                            }
                            return {
