                        ...
                        var TableManaged = function () {
                            ...
                            var initTable1 = function () {
                                ...
                                table.dataTable({
                                    "ajax": {
                                        'type': 'POST',
                                        'url': '<?php echo base_url("/transaksi/labnobatch/getRencanaOutAll"); ?>',
                                        'data': function (d) {
                                ...
                                table.on('click', 'tbody tr', function () {
                                    ...
                                    window.open( baseurl+"transaksi/labnobatch/selectedSO/"+noSO, "_self");
                                     */       
                                });
                            ...
                            if (noRow != null) {
                                bootbox.confirm("Anda yakin menyimpan data ini?", function (o) {
                                    if (o == true) {
                                        ...
                                        ajaxModal();
                                        if (noSO != '') {
                                            $.post("<?php echo site_url('/transaksi/labnobatch/ubah'); ?>",
                                                    {
                                                        'noSO': noSO,
                                                        'noBatch': noBatch,
                                                    }, function (data) {
                                                if (data.baris == 1) {
                                                    $('#id_tempNoBatch' + no).val(data.no_batch);
                                                    $('#' + idRow).find("td").eq(9).html(data.no_batch);
