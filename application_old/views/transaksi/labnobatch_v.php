        ...
        <div class="portlet portlet-sortable light bordered">
            ...
            <div class="portlet-body">
                ...
                <form class="" role="form" method="post"
                      action="<?php echo base_url('transaksi/labnobatch/home'); ?>" id="id_formAdvance">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="id_noBatch" required="required"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-actions ">
                        ...
                        <a href="<?php echo base_url('transaksi/labnobatch/home'); ?>" id="id_btnBatal"  class="btn default">Batal</a>
                    </div>
                </div>
            </div>
            </form>
...
<script>
                        ...
                        function ajaxSubmit() {
                            ...
                            $.ajax({
                                type: "POST",
                                dataType: "json",
                                url: "<?php echo base_url(); ?>transaksi/labnobatch/simpan",
                                data: dataString,
