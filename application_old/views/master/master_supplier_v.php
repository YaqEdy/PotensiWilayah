        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <div class="tab-content">
                      ...
                      action="<?php echo base_url('master/master_supplier/home'); ?>" id="id_formSpl">
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/master/master_supplier/getSplAll"); ?>",
                "columns": [
                    {"data": "idSpl"},
                    {"data": "namaSpl"},
                    {"data": "alamatSpl"},
    ...
    function getDescSpl(idSpl) {
        ajaxModal();
        if (idSpl != '') {
            $.post("<?php echo site_url('/master/master_supplier/getDescSpl'); ?>",
                    {
                        'idSpl': idSpl
                    }, function (data) {
                if (data.baris == 1) {
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_supplier/simpan",
            data: dataString,
    ...
    function ajaxUbah() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_supplier/ubah",
            data: dataString,
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
    ...
    function ajaxHapus() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_supplier/hapus",
            data: {idSpl: idSpl},
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
