...
$db['config1']['password'] = '';//mmsPNMonl1n3 plokijuh890-MNB plokijuh890-MNB perumnas
$db['config1']['database'] = 'db_pw2';//rusunawa db_potensi_wilayah2  
$db['config1']['dbdriver'] = 'mysqli';
$db['config1']['dbprefix'] = '';
