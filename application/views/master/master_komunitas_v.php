...
<script>
    ...
    function getDescKel(idKel) {
        ajaxModal();
        if (idKel != '') {
            $.post("<?php echo site_url('/master/master_komunitas/getDescKel'); ?>",
                    {
                        'idKel': idKel
                    }, function (data) {
                if (data.baris == 1) {
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_komunitas/simpan",
            data: dataString,
    ...
    function ajaxUbah() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_komunitas/ubah",
            data: dataString,
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
