...
<style type="text/css">
    ...
    table#idTabelKel td:nth-child(5) {
        text-align:right;
    }
</style>
<!-- END PAGE BREADCRUMB -->
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Data Lembaga Keuangan</span>
                </div>
                <div class="tools">
                ...
                <ul class="nav nav-pills">
                    <li class="linav active" id="linav1">
                        <a href="#tab_2_1" data-toggle="tab" id="navitab_2_1" class="anavitab">
                            Data Lembaga Keuangan </a>
                    </li>
                    <li class="linav" id="linav2">
                        <a href="#tab_2_2" data-toggle="tab" id="navitab_2_2" class="anavitab">
                            Form Lembaga Keuangan</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab_2_2">
                        <form role="form" method="post" class=""
                              action="<?php echo base_url('master/master_lkm/home'); ?>" id="id_formKel">
                                ...
                                <div class="form-body">
                                    <div class="col-md-6">
                                        <div class="form-group hidden">
                                            <label>NIK</label>
                                            <input id="id_lkmId"  class="form-control input-sm"
                                                   type="text" name="lkmId" />
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Lembaga Keuangan</label>
                                            <input id="id_namaLkm" class="form-control input-sm"
                                                   type="text" name="namaLkm" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="id_jmlAset" class="form-control input-sm nomor"
                                                   type="text" name="jmlAset" />
                                        </div>
                                        <div class="form-group">
                                            ...
                                            $data = array();
                                            $data[''] = '';
                                            foreach ($jenislk as $row) :
                                                $data[$row['id_jenislk']] = $row['nama_jenislk'];
                                            endforeach;
                                            echo form_dropdown('jenislk', $data, '', 'required id="id_jenislk" class="form-control input-sm select2me "');
                                            ?>
                                        </div>
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/master/master_lkm/getLkmAll"); ?>",
                "columns": [
                    {"data": "idLkm"},
                    {"data": "namaLkm"},
                    {"data": "kec"},
    ...
    function getDescKel(idKel) {
        ajaxModal();
        if (idKel != '') {
            $.post("<?php echo site_url('/master/master_lkm/getDescKel'); ?>",
                    {
                        'idKel': idKel
                    }, function (data) {
                if (data.baris == 1) {
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_lkm/simpan",
            data: dataString,
    ...
    function ajaxUbah() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_lkm/ubah",
            data: dataString,
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
    ...
    function ajaxHapus() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_lkm/hapus",
            data: {idKel: idKel},
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
