                            ...
                            <div class="row">
                                <div class="form-body">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label>Jenis Sentra Usaha</label>
                                            <?php
                                            
                                            $data = array();
                                            $data[''] = '';
                                            foreach ($jenissentra as $row) :
                                                $data[$row['id_jenissentra']] = $row['nama_jenissentra'];
                                            endforeach;
                                            echo form_dropdown('jenissentra', $data, '', 'required id="id_jenissentra" class="form-control input-sm select2me "');
                                            ?>
                                        </div>
