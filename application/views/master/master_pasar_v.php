        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Data Pasar</span>
                </div>
                <div class="tools">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="tab_2_2">
                        <form role="form" method="post" class=""
                              action="<?php echo base_url('master/master_pasar/home'); ?>" id="id_formKel">
                                ...
                                <div class="form-body">
                                    <div class="col-md-6">
                                        <div class="form-group hidden">
                                            <label>NIK</label>
                                            <input id="id_pasarId"  class="form-control input-sm"
                                                   type="text" name="pasarId" />
                                        </div>
                                        <div class="form-group">
                                            <label>Nama Pasar</label>
                                            <input id="id_namaPasar" class="form-control input-sm"
                                                   type="text" name="namaPasar" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="id_jmlPedagang" class="form-control input-sm nomor1"
                                                   type="text" name="jmlPedagang" />
                                        </div>
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/master/master_pasar/getPasarAll"); ?>",
                "columns": [
                    {"data": "idPasar"},
                    {"data": "namaPasar"},
                    {"data": "kec"},
    ...
    function getDescKel(idKel) {
        ajaxModal();
        if (idKel != '') {
            $.post("<?php echo site_url('/master/master_pasar/getDescKel'); ?>",
                    {
                        'idKel': idKel
                    }, function (data) {
                if (data.baris == 1) {
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_pasar/simpan",
            data: dataString,
    ...
    function ajaxUbah() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_pasar/ubah",
            data: dataString,
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
    ...
    function ajaxHapus() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>master/master_pasar/hapus",
            data: {idKel: idKel},
            success: function (data) {
                $('#id_Reload').trigger('click');
                $('#id_btnBatal').trigger('click');
