        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Koreksi Jurnal</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <form role="form" method="post"
                      action="<?php echo base_url('koreksi_jurnal/home'); ?>" id="id_formAkuntansi">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="input-icon">
                                                    ...
                                                    <input id="id_TanggalSearch" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" class="form-control date-picker input-sm" type="text" name="id_TanggalSearch" />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="id_NoReferensi" class="form-control input-sm"
                                               type="text" name="NoReferensi"/>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="2" cols="" name="Deskripsi" id="Deskripsi"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="trans_id" type="text" name="trans_id" style='display:none;'/>  <!--style='display:none;'-->
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTableJUunpost = function () {
            var table = $('#idtabeljuunpost').dataTable({
                "ajax": "<?php echo base_url("/akuntansi/koreksi_jurnal/getJurnalUnpostAll"); ?>",
                "columns": [
                    {"data": "aksi"},
                    {"data": "trans_id"},
                    {"data": "tgl_trans"},
    ...
    function getDescJU(idPerk) {
        $('#id_btnBatal').click();
        ajaxModal();
        $.post("<?php echo site_url('/akuntansi/koreksi_jurnal/getDescJU'); ?>",
                {
                    'idPerk': idPerk
                }, function (data)
        {
            if (data.data_ju.length > 0) {
                ...
                for (i = 0; i < data.data_ju.length; i++) {
                    ...
                    $('#tanggal_trans').val(data.data_ju[i].tgl_trans);
    ...
    function edit() {
        var idPerk = $(this).find("td").eq(1).html();
        $('#trans_id').val(idPerk);
        var tanggal = $(this).find("td").eq(2).html();
        $('#tanggal_trans').val(tanggal);
        alert(idPerk);
        //getDescJU(idPerk);
        //$('#navitab_2_2').click();
    }
...
//                            var kodeCflow = $(this).find("td input").eq(2).val();
        var db = $(this).find("td input").eq(2).val();
        var kr = $(this).find("td input").eq(3).val();
        db = parseFloat(CleanNumber(db));
        kr = parseFloat(CleanNumber(kr));
...
//                            $('#id_tempKodeCflow' + noRow).val(kodeCflow);
    ...
    function ajaxSubmit() {
        ...
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo base_url(); ?>akuntansi/koreksi_jurnal/simpan",
            data: dataString,
    ...
    function cetak(idPerk) {
        ...
        if (idJurnal == '') {
            ...
            window.open("<?php echo base_url('akuntansi/koreksi_jurnal/cetak/'); ?>/" + idPerk, '_blank');
        }
    }
        ...
        if (tanggal != '') {
            ...
            function tabelok(tanggal) {
                ...
                var table = $('#idtabeljuunpost').dataTable({
                    "ajax":
                            {
                                "url": "<?php echo base_url("/akuntansi/koreksi_jurnal/getJurnalUnpostAll"); ?>",
                                "type": "POST",
                                "data": dataForm
                            },
                    "columns": [
