            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td width="50%" align="center" class="judul"><?php echo $header ; ?></td>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="4">
                <tbody>
                    <tr class="cls_tr_header">
                        ...
                        <th width="10%" >Saldo per <?php echo $tglmin1; ?></th>
                    ...
                    <tr class="cls_tr_isi">
                            ...
                            <td  align="right"><?php echo number_format($dat->keluar_lain,2); ?></td>
                        ...
                        $tot_keluar_lain = $tot_keluar_lain + $dat->keluar_lain;
                    ...
                    <tr>
                        ...
                        <td  align="right"><?php echo number_format($tot_keluar_lain,2); ?></td>
