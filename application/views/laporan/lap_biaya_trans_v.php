                ...
                <div class="row">
                    <div class="col-md-9">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    <label>Jns Transaksi</label>
                                    <?php
                                    $data = array();
                                    $data[''] = 'Semua';
                                    foreach ($biaya_trans as $k) :
                                        $data[$k->kode_perk] = $k->nama_jns_transaksi;
                                    endforeach;
                                    echo form_dropdown('jns_transaksi', $data, '', 'id="id_jns_transaksi" class="form-control"');
                                    ?>
                                </div>
                            </div>
                            <div class="form-group"> 
...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            var idJnsTransaksi = $('#id_jns_transaksi').val();
            ...
            var table = $('#idTabelPO'),
                    t = table.dataTable({
                        "ajax": {
                            'type': 'POST',
                            'url': '<?php echo base_url("/laporan/lap_biaya_trans/getLapBiayaTrans"); ?>',
                            'data': function (d) {
                                d.tglAwalDaftar = $('#id_tglAwalDataDaftar').val();
                                d.tglAkhirDaftar = $('#id_tglAkhirDataDaftar').val();
                                d.idJnsTransaksi = $('#id_jns_transaksi').val();
                            }
                        },
                        "columns": [
                            {"data": "noSeq"},
