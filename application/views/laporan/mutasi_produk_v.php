                        ...
                        <div class="form-body">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    endforeach;
                                    echo form_dropdown('produk_jadi', $data, '', 'id="id_produk_jadi" class="form-control input-sm select2me"');
                                    ?>
                                </div>   
                            </div>
                            <div class="col-md-4">
...
//Ready Doc
                                    ...
                                    function cetak() {
                                        ...
                                        var produkId = $('#id_produk_jadi').val();
                                        if (produkId == '') {
                                            alert('Mohon pilih produk.');
                                        } else {
                                            window.open("<?php echo base_url('laporan/mutasi_produk/cetak/'); ?>/" + produkId +"/"+tglAwal+"/"+tglAkhir, '_blank');//+ idAdvance + masterId
                                        }
                                    }
</script>
