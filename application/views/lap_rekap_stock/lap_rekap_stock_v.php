...
<!--                            <div class="col-md-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    endforeach;
                                    echo form_dropdown('storage_produk_jadi', $data, '', 'id="id_storage_produk_jadi" class="form-control input-sm "');
                                    ?>
                                </div>   
                            </div>
                            <div class="col-md-4">
...
//                        });
                        ...
                        function getDescProduk(idProduk) {
                            ajaxModal();
                            if (idProduk != '') {
                                $.post("<?php echo site_url('lap_rekap_stock/lap_rekap_stock/getDescProduk'); ?>",
                                        {
                                            'idProduk': idProduk
                                        }, function (data) {
                                    if (data.baris == 1) {
                        ...
                        function getDescStorage(idStorage) {
                            ajaxModal();
                            if (idStorage != '') {
                                $.post("<?php echo site_url('lap_rekap_stock/lap_rekap_stock/getDescStorage'); ?>",
                                        {
                                            'idStorage': idStorage
                                        }, function (data) {
                                    if (data.baris == 1) {
