        ...
        <div class="portlet portlet-sortable light bordered">
            ...
            <div class="portlet-body">
                ...
                <form role="form" method="post"
                      action="<?php echo base_url('transaksi/trans_masuk/home'); ?>" id="id_formAdvance">
                                ...
                                <div class="form-body">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            endforeach;
                                            echo form_dropdown('produk', $data, '', 'id="id_produk" class="form-control select2me cls_hitungBerat"');
                                            ?>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="form-body">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <label>Selisih (Liter)</label>
                                            <input id="id_selisihLt" required="required" class="nomor form-control input-sm"
                                                   type="text" name="selisihLt" readonly />
                                        </div>
...
<script>
                        ...
                        function getDescProduk(idProduk) {
                            ajaxModal();
                            if (idProduk != '') {
                                $.post("<?php echo site_url('transaksi/trans_masuk/getDescProduk'); ?>",
                                        {
                                            'idProduk': idProduk
                                        }, function (data) {
                                    if (data.baris == 1) {
                        ...
                        function getDescStorage(idStorage) {
                            ajaxModal();
                            if (idStorage != '') {
                                $.post("<?php echo site_url('transaksi/trans_masuk/getDescStorage'); ?>",
                                        {
                                            'idStorage': idStorage
                                        }, function (data) {
                                    if (data.baris == 1) {
                        ...
                        function ajaxSubmitAdvance() {
                            ...
                            $.ajax({
                                type: "POST",
                                dataType: "json",
                                url: "<?php echo base_url(); ?>transaksi/trans_masuk/simpan",
                                data: dataString,
