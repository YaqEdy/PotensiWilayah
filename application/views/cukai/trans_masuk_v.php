                        ...
                        <div class="tab-pane fade active in" id="tab_2_1">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>No PO : </label>
                                        <span class="help-block"><strong><?php echo $info_po[0]->no_po; ?></strong></span>
                                        <input id="id_idMaster"
                                               class="form-control input-sm hidden" type="text"
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="help-block"><strong><?php echo $info_po[0]->nama_spl; ?></strong></span>
                                    </div>     
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>ETD : </label>
                                        <span class="help-block"><strong><?php echo date('d-m-Y', strtotime($info_po[0]->etd)); ?></strong></span>
                                    </div>     
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>ETA : </label>
                                        <span class="help-block"><strong><?php echo date('d-m-Y', strtotime($info_po[0]->eta)); ?></strong></span>
                                    </div>
                                </div>
                            </div>  
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help-block"><strong><?php echo $info_po[0]->no_batch; ?></strong></span>  
                                    </div>
                                </div>
                                <!--end <div class="col-md-6"> 1 -->
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help-block"><strong><?php echo $info_po[0]->no_cukai; ?></strong></span> 
                                    </div>     
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help-block"><strong><?php echo $info_po[0]->nama_pengirim; ?></strong></span>   
                                    </div>
                                </div>
                                <!--end <div class="col-md-6"> 1 -->
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help-block"><strong><?php echo $info_po[0]->no_mobil; ?></strong></span>
                                    </div>     
                                </div>
                                <!-- HIDDEN INPUT -->
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help-block"><strong><?php echo $info_po[0]->waktu_mulai_bongkar; ?></strong></span>   
                                    </div>
                                </div>
                                <!--end <div class="col-md-6"> 1 -->
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="help-block"><strong><?php echo $info_po[0]->waktu_selesai_bongkar; ?></strong></span>
                                    </div>     
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="form-body">
                                    <div class="col-md-4">    
                                        <div class="form-group">
                                            ...
                                            <span class="help-block"><strong><?php echo $info_po[0]->qty_spl_kg; ?></strong></span>
                                        </div>
                                        <div class="form-group">
                                            <label>Bruto (kg)</label>
                                            <span class="help-block"><strong><?php echo $info_po[0]->qty_bruto_kg; ?></strong></span>
                                        </div>
                                        <div class="form-group">
                                            <label>Tarra (kg)</label>
                                            <span class="help-block"><strong><?php echo $info_po[0]->qty_tarra_kg; ?></strong></span>
                                        </div>
                                        <div class="form-group">
                                            <label>Netto (kg)</label>
                                            <span class="help-block"><strong><?php echo $info_po[0]->qty_netto_kg; ?></strong></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Selisih (kg)</label>
                                            <span class="help-block"><strong><?php echo $info_po[0]->selisih_kg; ?></strong></span>
                                        </div>
                                        <div class="form-group">
                                            <label>Selisih (%)</label>
                                            <span class="help-block"><strong><?php echo $info_po[0]->selisih_persen; ?></strong></span>
                                        </div>                                        
                                        <div class="form-group">
                                            <label>Keterangan</label>
                                            <span class="help-block"><strong><?php echo $info_po[0]->keterangan_datang; ?></strong></span>
                                        </div>
                                            ...
                                            <tbody id="id_body_data">
                                                ...
                                                foreach ($rincian_po as $tr) {
                                                    ...
                                                    <tr class="listdata" id="tr<?php echo $i; ?>">
                                                        ...
                                                        <td width="10%">
                                                            <input type="text" class="form-control input-sm kanan" id="id_tempQty<?php echo $i; ?>" name="tempQty<?php echo $i; ?>" readonly="true" value="<?php echo number_format($tr->qty_realisasi, 2); ?>">
                                                        </td>
                                                        <td width="10%">
                                                            <input type="text" class="form-control input-sm kanan clsHitungQtyCukai" id="id_tempQtyCukai<?php echo $i; ?>" name="tempQtyCukai<?php echo $i; ?>"  value="<?php echo number_format($tr->qty_realisasi, 2); ?>">
                                                        </td>
                                                        <td width="15%">
                                                    ...
                                                    <?php
                                                    $i++;
                                                    $totqty = $totqty + $tr->qty_realisasi;
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-actions ">
                                        ...
                                        <a href="<?php echo base_url('cukai/trans_masuk/home/'); ?>" id="" type="button" class="btn default ">Batal</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
                                                            ...
                                                            function ajaxSubmitAdvance() {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    dataType: "json",
                                                                    url: "<?php echo base_url(); ?>cukai/trans_masuk/simpan",
                                                                    data: dataString,
