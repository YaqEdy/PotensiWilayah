...
class Lap_allcucian_m extends CI_Model {
    public function getCucianAmbil($tglAwal, $tglAkhir) {
/*        if($idKaryawan == ''){
 ...
 */
        $sql = "SELECT mc.id_master_cm, mc.no_bon_manual,mc.id_cust,mc.tgl_trans,mc.e_tgl_selesai,
            ...
            where mc.tgl_trans between '$tglAwal' and '$tglAkhir'   ";
        //where mc.tgl_trans between '$tglAwal' and '$tglAkhir'  ".$idKaryawan." ";
