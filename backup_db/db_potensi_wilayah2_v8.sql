...
-- ----------------------------
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_pend_non_formal` AS select `a`.`id_pend_non_formal` AS `id_pend_non_formal`,`a`.`id_ktp` AS `id_ktp`,`a`.`nama_pend` AS `nama_pend`,`a`.`jenis_pend` AS `jenis_pend`,`a`.`tahun` AS `tahun`,`a`.`ket` AS `ket`,`a`.`instansi` AS `instansi`,`a`.`idsession` AS `idsession`,`b`.`nama_ktp` AS `nama_ktp`,`c`.`nama_instansi` AS `nama_instansi`,`b`.`jekel` AS `jekel`,`b`.`tanggal_lahir` AS `tanggal_lahir` from ((`tbl_m_pend_non_formal` `a` join `master_ktp` `b` on((`a`.`id_ktp` = `b`.`id_ktp`))) join `tbl_m_instansi` `c` on((`a`.`instansi` = `c`.`id_instansi`)));

-- ----------------------------
-- View structure for vw_pend_non_formal_temp
-- ----------------------------
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_pend_non_formal_temp` AS select `a`.`id_pend_non_formal` AS `id_pend_non_formal`,`a`.`id_ktp` AS `id_ktp`,`a`.`nama_pend` AS `nama_pend`,`a`.`jenis_pend` AS `jenis_pend`,`a`.`tahun` AS `tahun`,`a`.`ket` AS `ket`,`a`.`instansi` AS `instansi`,`a`.`idsession` AS `idsession`,`b`.`nama_ktp` AS `nama_ktp`,`c`.`nama_instansi` AS `nama_instansi`,`b`.`jekel` AS `jekel`,`b`.`tanggal_lahir` AS `tanggal_lahir` from ((`tbl_m_pend_non_formal_temp` `a` join `master_ktp` `b` on((`a`.`id_ktp` = `b`.`id_ktp`))) join `tbl_m_instansi` `c` on((`a`.`instansi` = `c`.`id_instansi`)));
...
INSERT INTO `master_ktp` VALUES ('9887', 'Eko P', 'skjbdv', '2018-09-09', '0', 'O', 'bekasi', '9', '9', '5105020002', '5105020', '0', '0', '000001', '000000', '0', '', 'uploads/foto/748e299c-b515-11e8-b5ce-782bcbdbdcb7.jpg', '0', '90b3e051-b38e-11e8-b5ce-782bcbdbdcb7');
INSERT INTO `master_ktp_kk_temp` VALUES ('13', '90b3e051-b38e-11e8-b5ce-782bcbdbdcb7', '9887', 'Eko P', 'skjbdv', '2018-09-09', '0', 'O', 'bekasi', '9', '9', '5105020002', '5105020', '0', '0', '000001', '000000', '0', null, 'uploads/foto/748e299c-b515-11e8-b5ce-782bcbdbdcb7.jpg', '0', '999', '1', null, null, null, null, null);
...
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('14', '9887', 'mesin', 'training', '2017', 'opoooo', '000002', '5e15ab65-b531-11e8-b64e-782bcbdbdcb7');
...
INSERT INTO `tbl_m_rumah_temp` VALUES ('43', '999', 'uploads/foto/2e1a9a35-b38f-11e8-b5ce-782bcbdbdcb7.jpg', '90b3e051-b38e-11e8-b5ce-782bcbdbdcb7');
INSERT INTO `tbl_m_rumah_temp` VALUES ('44', '999', 'uploads/foto/2e3c49cf-b38f-11e8-b5ce-782bcbdbdcb7.jpg', '90b3e051-b38e-11e8-b5ce-782bcbdbdcb7');
...
INSERT INTO `tbl_t_anggota_komunitas` VALUES ('1', '000001', '9887', 'a5149c7e-b523-11e8-b5ce-782bcbdbdcb7');
...
INSERT INTO `tbl_t_anggota_komunitas_temp` VALUES ('93', '9887', 'a5149c7e-b523-11e8-b5ce-782bcbdbdcb7');
...
INSERT INTO `tbl_t_bantuan` VALUES ('57', 'e5d42d66-b525-11e8-b5ce-782bcbdbdcb7', '000001', '9887', '2018-09-11', 'Kursi Roda', 'Kegiatan sosial', '40', '2018-09-11 01:18:25', null, null);
INSERT INTO `tbl_t_bantuan_temp` VALUES ('2', 'e5d42d66-b525-11e8-b5ce-782bcbdbdcb7', '000001', '9887', '2018-09-11', 'Kursi Roda', 'Kegiatan sosial', '40', '2018-09-11 01:18:28');
INSERT INTO `tbl_t_bantuan_temp` VALUES ('3', '82aea924-b52c-11e8-b5ce-782bcbdbdcb7', '000001', '9887', '1970-01-01', '', 'bh', '40', '2018-09-10 21:05:41');
