...
-- ----------------------------
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_t_bantuan` AS select `a`.`id_t_bantuan` AS `id_t_bantuan`,`a`.`id_m_instansi` AS `id_m_instansi`,`b`.`nama_instansi` AS `nama_instansi`,`a`.`id_ktp` AS `id_ktp`,`a`.`nama_bantuan` AS `nama_bantuan`,`a`.`ket` AS `ket`,date_format(`a`.`tgl_bantuan`,'%d-%m-%Y') AS `tgl_bantuan`,`a`.`idsession` AS `idsession`,`c`.`nama_ktp` AS `nama_ktp`,`c`.`tempat_lahir` AS `tempat_lahir`,`c`.`tanggal_lahir` AS `tanggal_lahir`,`c`.`jekel` AS `jekel`,`c`.`gol_darah` AS `gol_darah`,`c`.`alamat` AS `alamat`,`c`.`rt` AS `rt`,`c`.`rw` AS `rw`,`c`.`id_kel` AS `id_kel`,`c`.`id_kec` AS `id_kec`,`c`.`agama` AS `agama`,`c`.`status_kawin` AS `status_kawin`,`c`.`pekerjaan` AS `pekerjaan`,`c`.`warga_negara` AS `warga_negara`,`c`.`link_gambar` AS `link_gambar`,`c`.`is_delete` AS `is_delete` from ((`tbl_t_bantuan` `a` join `tbl_m_instansi` `b` on((`a`.`id_m_instansi` = `b`.`id_instansi`))) join `master_ktp` `c` on((`a`.`id_ktp` = `c`.`id_ktp`)));

-- ----------------------------
-- View structure for vw_t_bantuan_temp
-- ----------------------------
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_t_bantuan_temp` AS select `a`.`id_t_bantuan` AS `id_t_bantuan`,`a`.`id_m_instansi` AS `id_m_instansi`,`b`.`nama_instansi` AS `nama_instansi`,`a`.`id_ktp` AS `id_ktp`,`a`.`nama_bantuan` AS `nama_bantuan`,`a`.`ket` AS `ket`,`a`.`tgl_bantuan` AS `tgl_bantuan`,`a`.`idsession` AS `idsession`,`c`.`nama_ktp` AS `nama_ktp`,`c`.`tempat_lahir` AS `tempat_lahir`,`c`.`tanggal_lahir` AS `tanggal_lahir`,`c`.`jekel` AS `jekel`,`c`.`gol_darah` AS `gol_darah`,`c`.`alamat` AS `alamat`,`c`.`rt` AS `rt`,`c`.`rw` AS `rw`,`c`.`id_kel` AS `id_kel`,`c`.`id_kec` AS `id_kec`,`c`.`agama` AS `agama`,`c`.`status_kawin` AS `status_kawin`,`c`.`pekerjaan` AS `pekerjaan`,`c`.`warga_negara` AS `warga_negara`,`c`.`link_gambar` AS `link_gambar`,`c`.`is_delete` AS `is_delete` from ((`tbl_t_bantuan_temp` `a` join `tbl_m_instansi` `b` on((`a`.`id_m_instansi` = `b`.`id_instansi`))) join `master_ktp` `c` on((`a`.`id_ktp` = `c`.`id_ktp`)));
...
INSERT INTO `master_ktp` VALUES ('08087908u8', 'kjbnkb jh', 'jvbjhv', '2018-09-08', '0', 'O', 'sjldbck sd', '5', '5', '5105030002', '5105030', '0', '0', '000001', '000002', '1', '', 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '0', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('4444656', 'hvjvguj', 'mvjg', '2018-09-08', '0', 'O', 'dhfvjdgvb', '77', '77', '5105010003', '5105020', '0', '0', '000001', '000000', '0', '', 'uploads/foto/733b4294-b33f-11e8-be30-782bcbdbdcb7.jpg', '0', '73395e26-b33f-11e8-be30-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('5543', ',nc jnbkj', 'mx', '2018-09-02', '0', 'O', 'sjldbck sd', '5', '5', '5105030002', '5105030', '0', '0', '000001', '000000', '0', '', 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '0', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('798', 'hvbu', 'jvg', '2018-09-08', '0', 'O', 'sjldbck sd', '5', '5', '5105030002', '5105030', '0', '0', '000001', '000000', '2', '', 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '0', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('8998789', 'jksdbhf', 'sjbkcks', '2018-09-02', '1', 'O', 'sdjbch', '9', '9', '5105020002', '5105020', '0', '0', '000001', null, null, '', 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg', '0', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('999', 'dsjbcsch', 'bskdfvbjj', '2018-09-02', '0', 'O', 'sdjbch', '9', '9', '5105020002', '5105020', '0', '0', '000001', null, null, '', 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg', '0', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('9999922', 'kjxbvk', 'kdxbv', '2018-09-08', '0', 'A', 'dfifb', '999', '999', '5105010003', '5105010', '0', '0', '000001', '000000', '0', '', 'uploads/foto/11f482b8-b33f-11e8-be30-782bcbdbdcb7.jpg', '0', '11f2b7ae-b33f-11e8-be30-782bcbdbdcb7');
INSERT INTO `master_ktp_kk_temp` VALUES ('10', '061cb085-aec6-11e8-9980-782bcbdbdcb7', '08087908u8', 'kjbnkb jh', 'jvbjhv', '2018-09-08', '0', 'O', 'sjldbck sd', '5', '5', '5105030002', '5105030', '0', '0', '000001', '000002', '1', null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '0', '89787', '3', null, null, null, null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg');
INSERT INTO `master_ktp_kk_temp` VALUES ('11', '061cb085-aec6-11e8-9980-782bcbdbdcb7', '5543', ',nc jnbkj', 'mx', '2018-09-02', '0', 'O', 'sjldbck sd', '5', '5', '5105030002', '5105030', '0', '0', '000001', '000000', '0', null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '0', '89787', '1', null, null, null, null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg');
INSERT INTO `master_ktp_kk_temp` VALUES ('12', '061cb085-aec6-11e8-9980-782bcbdbdcb7', '798', 'hvbu', 'jvg', '2018-09-08', '0', 'O', 'sjldbck sd', '5', '5', '5105030002', '5105030', '0', '0', '000001', '000000', '2', null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '0', '89787', '3', null, null, null, null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg');
INSERT INTO `master_ktp_kk_temp` VALUES ('13', '061cb085-aec6-11e8-9980-782bcbdbdcb7', '888888876', 'oouj', 'lnjo', '2018-09-08', '0', 'O', 'kdbcdsc', '9', '9', '5105030002', '5105020', '0', '0', '000002', '000000', '1', null, 'uploads/foto/dc7a7e04-b33e-11e8-be30-782bcbdbdcb7.jpg', '0', '888989898989', '1', null, null, null, null, 'uploads/foto/dc78fe5f-b33e-11e8-be30-782bcbdbdcb7.jpg');
INSERT INTO `master_ktp_kk_temp` VALUES ('14', '0121d86d-b33f-11e8-be30-782bcbdbdcb7', '9999922', 'kjxbvk', 'kdxbv ', '2018-09-08', '0', '', 'dfifb', '999', '999', '5105010003', '5105010', '', '', '', '', '', null, null, '0', '999999', '', null, null, null, null, 'uploads/foto/012293bb-b33f-11e8-be30-782bcbdbdcb7.jpg');
INSERT INTO `master_ktp_kk_temp` VALUES ('16', '11f2b7ae-b33f-11e8-be30-782bcbdbdcb7', '9999922', 'kjxbvk', 'kdxbv', '2018-09-08', '0', 'A', 'dfifb', '999', '999', '5105010003', '5105010', '0', '0', '000001', '000000', '0', null, 'uploads/foto/11f482b8-b33f-11e8-be30-782bcbdbdcb7.jpg', '0', '999999', '1', null, null, null, null, 'uploads/foto/11f31ff6-b33f-11e8-be30-782bcbdbdcb7.jpg');
...
INSERT INTO `sec_menu_copy` VALUES ('4', 'Menu', 'admin/sec_menu_user/home', 'Konfigurasi Menu', '+1+2', '3', '1', '0');
INSERT INTO `sec_menu_copy` VALUES ('5', 'User', 'sec_user/home', 'Konfigurasi User', '+1+2', '4', '1', '0');
INSERT INTO `sec_menu_copy` VALUES ('63', 'Karyawan', 'master_karyawan/home', 'Master Karyawan', '+1+2', '8', '1', '0');
INSERT INTO `sec_menu_copy` VALUES ('64', 'Data master', '#', '', '+4+5+1+2+3', '7', '0', '0');
INSERT INTO `sec_menu_copy` VALUES ('85', 'Departement', 'master_dept/home', 'Data Master Departement', '+1+2', '16', '1', '0');
INSERT INTO `sec_menu_copy` VALUES ('97', 'Laporan', '#', '', '+4+5+6+1+2', '14', '0', '0');
INSERT INTO `sec_menu_copy` VALUES ('126', 'Transaksi', '#', '', '+7+4+5+6+1+2', '8', '0', '0');
INSERT INTO `sec_menu_copy` VALUES ('142', 'Agen', 'master/master_agen/home', 'Data Master Agen', '+1+2', '7', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('144', 'Laba Rugi', 'laporan/laporan_laba_rugi/home', 'Laporan Laba Rugi', '0+4+5+6+1+2', '5', '97', '0');
INSERT INTO `sec_menu_copy` VALUES ('145', 'Utilitas', '#', '', '+1+2', '16', '0', '0');
INSERT INTO `sec_menu_copy` VALUES ('146', 'Backup DB', 'utility/utility_db/home', 'Proses Backup DB', '+1+2', '1', '145', '0');
INSERT INTO `sec_menu_copy` VALUES ('147', 'Restore DB', 'utility/restore_db/home', 'Proses Restore DB', '+1', '2', '145', '0');
INSERT INTO `sec_menu_copy` VALUES ('153', 'Supplier', 'master/master_supplier/home', 'Data Master Supplier', '+1', '6', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('155', 'Pengeluaran produk', 'transaksi/trans_keluar/home', 'Data pengeluaran produk ke customer', '', '19', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('156', 'Pencampuran produk', 'transaksi/trans_campur/home', 'Data pencampuran produk', '+1', '20', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('157', 'Posisi Keuangan', 'laporan/laporan_neraca_c/home', 'Laporan Posisi Keuangan', '+1+2', '4', '97', '0');
INSERT INTO `sec_menu_copy` VALUES ('158', 'Cucian Masuk', 'transaksi/trans_po/home', 'Transaksi Penerimaan Cucian', '+7+1+2', '4', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('159', 'Biaya Operasional', 'transaksi/trans_biaya/home', 'Form Input Biaya Transaksi Operasional', '+1+2', '6', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('160', 'Hapus Transaksi', 'transaksi/hapus_trans/home', 'Form Hapus Transaksi', '+1+2', '7', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('161', 'Cucian -', 'transaksi/sales_order/home', 'Transaksi Penerimaan Cucian', '+1', '8', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('162', 'Packaging Pengiriman', 'transaksi/packaging/home', 'Packaging Pengiriman', '+1', '17', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('163', 'Approval Pengiriman', 'transaksi/trans_app_kirim/home', 'Approval Pengiriman', '+1', '18', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('165', 'Customer', 'master/master_cust/home', 'Data Master Customer', '+4+1+2', '7', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('166', 'Produk', 'master/master_produk/home', 'Data Master Jasa Satuan', '+4+5+1+2', '8', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('167', 'Perkiraan', 'master/master_perkiraan/home', 'Data Master Perkiraan', '+1+2', '9', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('168', 'Dashboard', '#', '', '+7+4+5+6+1+2+3', '4', '0', '0');
INSERT INTO `sec_menu_copy` VALUES ('169', 'Stok Akhir', 'main/index', 'Dashboard ketersediaan produk', '+7+4+5+6+1+2', '6', '168', '0');
INSERT INTO `sec_menu_copy` VALUES ('170', 'Layar Penuh', 'main/dashboard', 'Dashboard Potensi Wilayah', '+7+4+5+6+1+2+3', '7', '168', '0');
INSERT INTO `sec_menu_copy` VALUES ('171', 'GA Cukai', 'transaksi/ganocukai/home', 'Form Input No Cukai', '+4+1', '9', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('172', 'Batch Input', 'transaksi/labnobatch/home', 'Form Input No Batch', '+6+1', '10', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('173', 'Distribusi', 'transaksi/distribusi/home', 'Distribusi', '+5+1', '12', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('181', 'Outsource', 'master/master_outsource/home', 'Data Master Eksternal', '+1+2', '13', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('182', 'Integrasi Jurnal', 'admin/integrasi_jurnal/home', 'Konfigurasi Integrasi Jurnal', '+1+2', '18', '1', '0');
INSERT INTO `sec_menu_copy` VALUES ('183', 'Form Cukai', '#', '', '', '13', '0', '0');
INSERT INTO `sec_menu_copy` VALUES ('184', 'Kedatangan', 'cukai/trans_masuk/home', 'Form Kedatangan Barang (Cukai)', '', '5', '183', '0');
INSERT INTO `sec_menu_copy` VALUES ('185', 'Pengeluaran produk', 'cukai/trans_keluar/home', 'Form Pengeluaran Produk (Cukai)', '', '6', '183', '0');
INSERT INTO `sec_menu_copy` VALUES ('186', 'Stok Cukai', 'main/stokcukai', 'Dashboard Stok Cukai', '+1', '8', '168', '0');
INSERT INTO `sec_menu_copy` VALUES ('187', 'Keuangan', '#', '', '+1+2', '12', '0', '0');
INSERT INTO `sec_menu_copy` VALUES ('188', 'Koreksi Jurnal', 'akuntansi/koreksi_jurnal/home', 'Koreksi Jurnal', '+1+2', '6', '187', '0');
INSERT INTO `sec_menu_copy` VALUES ('189', 'Agen', 'laporan/lap_piutang_agen/home', 'Laporan Piutang Agen', '+4+5+6+1+2', '8', '97', '0');
INSERT INTO `sec_menu_copy` VALUES ('190', 'Outsource', 'laporan/lap_hutang_outsource/home', 'Laporan Hutang Outsource', '+4+5+6+1+2', '8', '97', '0');
INSERT INTO `sec_menu_copy` VALUES ('191', 'Jasa Karyawan', 'laporan/lap_jasa_kyw/home', 'Laporan Jasa Karyawan', '+4+5+1+2', '9', '97', '0');
INSERT INTO `sec_menu_copy` VALUES ('192', 'Biaya Transaksi', 'laporan/lap_biaya_trans/home', 'Laporan Biaya Transaksi', '+1+2', '10', '97', '0');
INSERT INTO `sec_menu_copy` VALUES ('193', 'Semua Cucian', 'laporan/lap_allcucian/home', 'Laporan Semua Cucian', '+1+2', '11', '97', '0');
INSERT INTO `sec_menu_copy` VALUES ('194', 'Pengambilan', 'laporan/lap_trans_ambil/home', 'Laporan Transaksi Pengambilan', '+1+2', '6', '97', '0');
INSERT INTO `sec_menu_copy` VALUES ('195', 'Mutasi Gudang', 'transaksi/mutgudang/home', 'Form Mutasi Gudang', '+1', '21', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('196', 'Adjustment Produk', 'transaksi/adjustment/home', 'Adjustment Pengeluaran Barang', '+1', '22', '126', '0');
INSERT INTO `sec_menu_copy` VALUES ('197', 'Jurnal', 'akuntansi/akuntansi/home', 'Penjurnalan', '+1+2', '5', '187', '0');
INSERT INTO `sec_menu_copy` VALUES ('198', 'Jenis Transaksi', 'admin/jns_trans/home', 'Form Input Jenis Transaksi', '+2', '19', '1', '0');
INSERT INTO `sec_menu_copy` VALUES ('199', 'Kecamatan', 'master/master_kecamatan/home', 'Master Kecamatan', '+2+3', '1', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('200', 'Kelurahan', 'master/master_kelurahan/home', 'Data Kelurahan', '+2+3', '2', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('201', 'KTP', 'master/master_ktp/home', 'Master Data KTP', '+2+3', '3', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('202', 'KK', 'transaksi/trans_kk/home', 'Data Master Kartu Keluarga', '+2+3', '3', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('203', 'Sentra Usaha', 'master/master_su/home', 'Data Sentra Usaha', '+2+3', '4', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('204', 'Komunitas', 'master/master_komunitas/home', 'Data Komunitas', '+2+3', '5', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('205', 'Pasar', 'master/master_pasar/home', 'Data Pasar', '+2+3', '5', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('206', 'Lembaga Keuangan', 'master/master_lkm/home', 'Data Lembaga Keuangan', '+2+3', '6', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('207', 'Parameter', '#', '', '+2+3', '6', '0', '0');
INSERT INTO `sec_menu_copy` VALUES ('208', 'Jenis Sentra', 'master/master_jenissentra/home', 'Data Jenis Sentra', '+2+3', '3', '207', '0');
INSERT INTO `sec_menu_copy` VALUES ('209', 'Jenis Komunitas', 'master/master_jeniskomunitas/home', 'Data Jenis Komunitas', '+2+3', '2', '207', '0');
INSERT INTO `sec_menu_copy` VALUES ('210', 'Jenis L Keuangan', 'master/master_jenislk/home', 'Data Jenis Lembaga Keuangan', '+2+3', '5', '207', '0');
INSERT INTO `sec_menu_copy` VALUES ('211', 'Difabel', 'master/master_difabel/home', 'Difabel', '+2+3', '7', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('212', 'Pekerjaan', 'master/master_pekerjaan/home', 'Pekerjaan', '+2+3', '8', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('213', 'Instansi', 'master/master_instansi/home', 'Instansi', '+2+3', '9', '64', '0');
INSERT INTO `sec_menu_copy` VALUES ('214', 'Trans Bantuan', 'transaksi/trans_bantuan/home', 'Trans Bantuan', '+2+3', '10', '64', '0');
...
INSERT INTO `tbl_m_pend_formal` VALUES ('6', '999', '0', '', '', '', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal` VALUES ('7', '8998789', '0', '', '', '', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal` VALUES ('10', '5543', '0', '', '', '', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('40', '000999', '0', '', '', '', '');
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('45', '57667', '0', '', '', '', '');
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('46', '7678', '0', '', '', '', '5e5a7cbf-aec5-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('96', '999', '0', '', '', '', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('97', '8998789', '0', '', '', '', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('100', '5543', '0', '', '', '', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal` VALUES ('6', '999', '', '', '', '', ' ', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal` VALUES ('7', '8998789', '', '', '', '', '0', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal` VALUES ('10', '5543', '', '', '', '', '0', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('40', '000999', '', '', '', '', '0', '');
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('45', '57667', '', '', '', '', '0', '');
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('46', '7678', '', '', '', '', '0', '5e5a7cbf-aec5-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('96', '999', '', '', '', '', ' ', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('97', '8998789', '', '', '', '', '0', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('100', '5543', '', '', '', '', '0', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
...
INSERT INTO `tbl_t_anggota_komunitas_temp` VALUES ('86', '889889', '5d487d75-adcb-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_t_anggota_komunitas_temp` VALUES ('90', '90', '5d000a77-adcc-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_t_anggota_komunitas_temp` VALUES ('91', '778', '5d000a77-adcc-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_t_bantuan` VALUES ('56', '28347c80-aec7-11e8-9980-782bcbdbdcb7', '000001', '8998789', '2018-09-02', 'sembako', 'makan', '40', '2018-09-02 22:45:08', null, null);
INSERT INTO `trans_kk` VALUES ('31', '123', '999', '0', '1', null, null, null, null, 'uploads/foto/ecc51c6e-aeb8-11e8-9980-782bcbdbdcb7.jpg', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('32', '123', '8998789', '0', '3', null, null, null, null, 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('36', '89787', '5543', '0', '1', null, null, null, null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('37', '89787', '798', '0', '3', null, null, null, null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('38', '89787', '08087908u8', '0', '3', null, null, null, null, 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('39', '999999', '9999922', '0', '1', null, null, null, null, 'uploads/foto/11f31ff6-b33f-11e8-be30-782bcbdbdcb7.jpg', '11f2b7ae-b33f-11e8-be30-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('40', '7778', '4444656', '0', '1', null, null, null, null, 'uploads/foto/7339c8ef-b33f-11e8-be30-782bcbdbdcb7.jpg', '73395e26-b33f-11e8-be30-782bcbdbdcb7');
