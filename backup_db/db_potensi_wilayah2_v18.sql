...
-- ----------------------------
-- Table structure for master_banjar
-- ----------------------------
CREATE TABLE `master_banjar` (
  `id_banjar` varchar(16) NOT NULL,
  `id_kel` varchar(16) NOT NULL,
  `nama_banjar` varchar(45) NOT NULL,
...
CREATE TABLE `master_ktp` (
  ...
  `gol_darah` char(2) DEFAULT '-',
  `alamat` varchar(45) DEFAULT '',
  `rt` char(3) DEFAULT '',
  `rw` char(3) DEFAULT '',
  `id_kel` char(10) DEFAULT '',
  `id_kec` char(10) DEFAULT '',
  `id_banjar` char(10) DEFAULT NULL,
  ...
  `id_kemiskinan` varchar(10) DEFAULT NULL,
...
CREATE TABLE `master_ktp_kk_temp` (
  ...
  `id_banjar` varchar(50) DEFAULT NULL,
  ...
  `id_kemiskinan` varchar(50) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for tbl_r_kemiskinan
-- ----------------------------
CREATE TABLE `tbl_r_kemiskinan` (
  `id_kemiskinan` tinyint(1) NOT NULL,
  `nama_kemiskinan` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id_kemiskinan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `master_komunitas` VALUES ('000001', 'K Pencinta Anjing Herder', 'Bali 123', '5105040', '5105040006', 'Ruly Siantana', '0811552289', '000001');
...
INSERT INTO `master_ktp` VALUES ('3211', 'I Ketut w', 'Bali', '2018-09-22', '0', 'O', 'Bali', '9', '9', '5105010001', '5105010', '500145', '0', '1', '000002', '000003', '5', '2', '', null, '0', '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('7765', 'ninik', 'bali', '2018-10-08', '1', 'A', 'Bali', '9', '9', '5105010001', '5105010', '500145', '0', '1', '000004', '000002', '3', '2', '', null, '0', '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('88745', 'Eko', 'Bali', '2018-10-14', '0', 'AB', 'Bali', '8', '8', '5105020006', '5105020', '500039', '0', '0', '000005', '000001', '0', '1', '', null, '0', 'c72170f8-cfc0-11e8-bbb4-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('998654', 'Eko', 'Bali', '2018-10-13', '0', 'A', 'Bali', '9', '9', '5105010001', '5105010', '500145', '0', '0', '000005', '000003', '1', '2', '', null, '0', '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `master_ktp_kk_temp` VALUES ('66', 'c72170f8-cfc0-11e8-bbb4-782bcbdbdcb7', '88745', 'Eko', 'Bali', '2018-10-14', '0', 'AB', 'Bali', '8', '8', null, '5105020006', '5105020', '0', '0', '000005', '000001', '0', '1', null, null, '0', '22345', '1', null, null, null, null, null);
INSERT INTO `master_ktp_kk_temp` VALUES ('67', '9346135d-be6f-11e8-b64e-782bcbdbdcb7', '3211', 'I Ketut w', 'Bali', '2018-09-22', '0', 'O', 'Bali', '9', '9', null, '5105010001', '5105010', '0', '1', '000002', '000003', '5', '2', null, null, '0', '123456', '1', null, null, null, null, null);
INSERT INTO `master_ktp_kk_temp` VALUES ('68', '9346135d-be6f-11e8-b64e-782bcbdbdcb7', '7765', 'ninik', 'bali', '2018-10-08', '1', 'A', 'Bali', '9', '9', null, '5105010001', '5105010', '0', '1', '000004', '000002', '3', '2', null, null, '0', '123456', '2', null, null, null, null, null);
INSERT INTO `master_ktp_kk_temp` VALUES ('69', '9346135d-be6f-11e8-b64e-782bcbdbdcb7', '998654', 'Eko', 'Bali', '2018-10-13', '0', 'A', 'Bali', '9', '9', null, '5105010001', '5105010', '0', '0', '000005', '000003', '1', '2', null, null, '0', '123456', '3', null, null, null, null, null);
...
INSERT INTO `sec_menu` VALUES ('219', 'Laporan Bantuan', 'laporan/lap_bantuan/home', 'Laporan Bantuan', '+2+3', '14', '97', '0');
...
INSERT INTO `tbl_m_rumah` VALUES ('21', '123456', 'uploads/foto/f03367f1-be71-11e8-b64e-782bcbdbdcb7.jpg', '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `tbl_m_rumah` VALUES ('22', '123456', 'uploads/foto/739bf00a-cf04-11e8-bbb4-782bcbdbdcb7.jpg', '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `tbl_m_rumah_temp` VALUES ('95', '123456', 'uploads/foto/f03367f1-be71-11e8-b64e-782bcbdbdcb7.jpg', '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `tbl_m_rumah_temp` VALUES ('96', '123456', 'uploads/foto/739bf00a-cf04-11e8-bbb4-782bcbdbdcb7.jpg', '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
...
INSERT INTO `tbl_r_kemiskinan` VALUES ('1', 'Miskin');
INSERT INTO `tbl_r_kemiskinan` VALUES ('2', 'Sedang');
INSERT INTO `tbl_r_kemiskinan` VALUES ('3', 'Tidak Miskin');
...
INSERT INTO `tbl_t_anggota_komunitas` VALUES ('2', '000001', '7765', '74dad5ba-ca6e-11e8-b64e-782bcbdbdcb7');
...
INSERT INTO `trans_kk` VALUES ('32', '123456', '3211', '0', '1', null, null, null, null, null, '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('33', '123456', '7765', '0', '2', null, null, null, null, null, '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('34', '123456', '998654', '0', '3', null, null, null, null, null, '9346135d-be6f-11e8-b64e-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('37', '22345', '88745', '0', '1', null, null, null, null, null, 'c72170f8-cfc0-11e8-bbb4-782bcbdbdcb7');
