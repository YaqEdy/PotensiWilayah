...
-- ----------------------------
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `vw_anggota_kel_temp` AS select `a`.`id` AS `id`,`a`.`idsession` AS `idsession`,`a`.`id_ktp` AS `id_ktp`,`a`.`nama_ktp` AS `nama_ktp`,`a`.`tempat_lahir` AS `tempat_lahir`,`a`.`tanggal_lahir` AS `tanggal_lahir`,`a`.`jekel` AS `jekel`,`a`.`gol_darah` AS `gol_darah`,`b`.`nama_agama` AS `nama_agama`,`c`.`nama_nikah` AS `nama_nikah`,`d`.`nama_pekerjaan` AS `nama_pekerjaan`,`e`.`nama_hub_kel` AS `nama_hub_kel`,(case when (`a`.`warga_negara` = 0) then 'WNI' else 'WNA' end) AS `warga_negara` from ((((`master_ktp_kk_temp` `a` join `tbl_m_agama` `b` on((`a`.`agama` = `b`.`id_agama`))) join `tbl_r_status_nikah` `c` on((`a`.`status_kawin` = `c`.`id_nikah`))) join `tbl_m_pekerjaan` `d` on((`a`.`pekerjaan` = `d`.`id_pekerjaan`))) join `tbl_r_hub_kel` `e` on((`a`.`hub_keluarga` = `e`.`id_hub_kel`)));
...
INSERT INTO `master_ktp` VALUES ('5543', ',nc jnbkj', 'mx', '2018-09-02', '0', 'O', 'sjldbck sd', '5', '5', '5105030002', '5105030', '0', '0', '000001', '0', 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '0', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('8998789', 'jksdbhf', 'sjbkcks', '2018-09-02', '1', 'O', 'sdjbch', '9', '9', '5105020002', '5105020', '0', '0', '000001', '0', 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg', '0', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `master_ktp` VALUES ('999', 'dsjbcsch', 'bskdfvbjj', '2018-09-02', '0', 'O', 'sdjbch', '9', '9', '5105020002', '5105020', '0', '0', '000001', '0', 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg', '0', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `master_ktp_kk_temp` VALUES ('81', '061cb085-aec6-11e8-9980-782bcbdbdcb7', '5543', ',nc jnbkj', 'mx', '2018-09-02', '0', 'O', 'sjldbck sd', '5', '5', '5105030002', '5105030', '0', '0', '000001', '0', 'uploads/foto/061e9a79-aec6-11e8-9980-782bcbdbdcb7.jpg', '0', '89787', '1', null, null, null, null, 'uploads/foto/061d1649-aec6-11e8-9980-782bcbdbdcb7.jpg');
INSERT INTO `master_ktp_kk_temp` VALUES ('88', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7', '999', 'dsjbcsch', 'bskdfvbjj', '2018-09-02', '0', 'O', 'sdjbch', '9', '9', '5105020002', '5105020', '0', '0', '000001', '0', 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg', '0', '123', '1', null, null, null, null, 'uploads/foto/ecc51c6e-aeb8-11e8-9980-782bcbdbdcb7.jpg');
INSERT INTO `master_ktp_kk_temp` VALUES ('89', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7', '8998789', 'jksdbhf', 'sjbkcks', '2018-09-02', '1', 'O', 'sdjbch', '9', '9', '5105020002', '5105020', '0', '0', '000001', '0', 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg', '0', '123', '3', null, null, null, null, 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg');
...
INSERT INTO `tbl_m_pend_formal` VALUES ('2', '999', '0', '', '', '', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal` VALUES ('3', '8998789', '0', '', '', '', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal` VALUES ('5', '5543', '0', '', '', '', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
...
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('56', '5543', '0', '', '', '', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('63', '999', '0', '', '', '', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_formal_temp` VALUES ('64', '8998789', '0', '', '', '', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal` VALUES ('2', '999', '', '', '', '', ' ', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal` VALUES ('3', '8998789', '', '', '', '', '0', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal` VALUES ('5', '5543', '', '', '', '', '0', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
...
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('56', '5543', '', '', '', '', '0', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('63', '999', '', '', '', '', ' ', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `tbl_m_pend_non_formal_temp` VALUES ('64', '8998789', '', '', '', '', '0', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
...
INSERT INTO `trans_kk` VALUES ('27', '123', '999', '0', '1', null, null, null, null, 'uploads/foto/ecc51c6e-aeb8-11e8-9980-782bcbdbdcb7.jpg', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('28', '123', '8998789', '0', '3', null, null, null, null, 'uploads/foto/eccc18de-aeb8-11e8-9980-782bcbdbdcb7.jpg', 'ecc4cbec-aeb8-11e8-9980-782bcbdbdcb7');
INSERT INTO `trans_kk` VALUES ('30', '89787', '5543', '0', '1', null, null, null, null, 'uploads/foto/061d1649-aec6-11e8-9980-782bcbdbdcb7.jpg', '061cb085-aec6-11e8-9980-782bcbdbdcb7');
